...
//	private Box boxmainjpcr;
	...
	public LopHoc()  {
        ...
        jl1 = new JLabel("Danh Sách Lớp Học", SwingConstants.CENTER);
        ...
        jln1 = new JLabel("Thông tin LớpHọc");
    	...
    	ImageIcon originalicon = new ImageIcon(getClass().getResource("/img/group-chat.png"));
    	...
    	jltenlop = new JLabel("Tên Lóp Học : ");
    	jltenlop.setFont(new Font("Arial",Font.BOLD,14));
    	txttenlop = new JTextField(10);
    	txttenlop.setBorder(lb);
    	
    	jlkhoahoc = new JLabel("Khóa Học : ");
    	jlkhoahoc.setFont(new Font("Arial",Font.BOLD,14));
    	txtkhoahoc = new JTextField(10);
    	txtkhoahoc.setBorder(lb);
    	...
    	jlgiangvien = new JLabel("Mã Giảng Viên : ");
    	jlgiangvien.setFont(new Font("Arial",Font.BOLD,14));
    	txtgiangvien = new JTextField(10);
    	txtgiangvien.setBorder(lb);
    	...
    	boxjplc1.add(jltenlop);
    	boxjplc1.add(box.createVerticalStrut(8));
    	boxjplc1.add(jlkhoa);
    	boxjplc1.add(box.createVerticalStrut(8));
    	boxjplc1.add(jlkhoahoc);
    	boxjplc1.add(box.createVerticalStrut(8));
    	boxjplc1.add(jlgiangvien);
    	
    	boxjplc2.add(txtmalop);
    	boxjplc2.add(box.createVerticalStrut(5));
    	boxjplc2.add(txttenlop);
    	boxjplc2.add(box.createVerticalStrut(5));
    	boxjplc2.add(txtkhoa);
    	boxjplc2.add(box.createVerticalStrut(5));
    	boxjplc2.add(txtkhoahoc);
    	boxjplc2.add(box.createVerticalStrut(5));
    	boxjplc2.add(txtgiangvien);
    	...
    	String coll[] = {"Mã Lớp Học","Tên Lớp Học","Khoa","Khóa Học","Mã Giáo Viên"};
